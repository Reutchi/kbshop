...
const AccessoriesSection: React.FC = () => {
    ...
    const accessoriesCardItems: accessoriesCardProduct[] = [
        {
            ...
            link: '/',
            alt: 'keyboard image',
            img: '/assetsaccessories/keyboard1.webp',
        },
        {
            id: 2,
            title: 'Keyboard DIY kit',
            link: '',
            alt: 'keyboard image',
            img: '/assetsaccessories/keyboard2.webp',
        },
    ];
    ...
    return (
        <section
            ref={targetRef}
            className="flex md:flex-row flex-col justify-center mx-6 md:mx-16 mt-24 gap-8"
        >
